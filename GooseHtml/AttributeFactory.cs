...
internal static class AttributeFactory
{
	internal static Attributes.Attribute Create(string key, string value)
	{
		return key switch
		{
			AttributeNames.Accept => new Accept(value),
			AttributeNames.AcceptCharset => new AcceptCharset(value),
			...
			"high" => new High(value),
			AttributeNames.Href => new Href(value),
			"hreflang" => new Hreflang(value),
			"httpequiv" => new HttpEquiv(value),
			AttributeNames.Id => new Id(value),
			...
			AttributeNames.Name => new Name(value),
			...
			AttributeNames.Rel => new Rel(value),
			...
			AttributeNames.Type => new Attributes.Type(value),
			"usemap" => new Usemap(value),
			AttributeNames.Value => new Value(value),
