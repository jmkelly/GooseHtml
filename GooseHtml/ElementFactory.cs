...
{
    private static readonly Dictionary<string, Func<Element>> _elementFactories = new()
    {
        ...
        { "circle", () => new Circle() },
        { "cite", () => new Cite() },
        { "c-wiz", () => new Element(name: "c-wiz") },
        { "c-data", () => new Element(name: "c-data") },
        ...
        { "form", () => new Form() },
        { "g", () => new G() },
        { "gu-island", () => new Element("gu-island") },
    ...
    {
        if (_elementFactories.TryGetValue(tagName, out var factory))
        {
            return factory();
        }
